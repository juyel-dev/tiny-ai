...
def main():
    p = argparse.ArgumentParser(description="Download the pinned Databricks Dolly 15K JSONL dataset.")
    ...
    if out.exists() and not args.force:
        ...
        if actual == EXPECTED_SHA256:
            ...
            return
        raise RuntimeError(
            f"Existing file has unexpected SHA-256: {actual}. Use --force to replace it."
        )
